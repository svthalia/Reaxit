...
typedef FaceDetectionState = ListState<AlbumPhoto>;

class FaceDetectionCubit extends Cubit<FaceDetectionState>
    implements GalleryCubit<FaceDetectionState> {
  ...
  FaceDetectionCubit(this.api)
    : super(const FaceDetectionState.loading(results: []));
  ...
  Future<void> load() async {
    ...
    try {
      ...
      emit(FaceDetectionState.failure(message: exception.message));
    }
  }
