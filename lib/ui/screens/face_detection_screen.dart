...
class _FaceDetectionScreenState extends State<FaceDetectionScreen> {
  ...
  late final FaceDetectionCubit _cubit;

  @override
  void initState() {
    _controller = ScrollController()..addListener(_scrollListener);
    _cubit = FaceDetectionCubit(RepositoryProvider.of<ApiRepository>(context))
      ..load();
    super.initState();
  }
...
class _PhotoGridScrollView extends StatelessWidget {
  ...
  void _openGallery(BuildContext context, int index) {
    final cubit = BlocProvider.of<FaceDetectionCubit>(context);
    showDialog(
      context: context,
      useSafeArea: false,
      ...
      builder: (context) {
        return BlocProvider.value(
          ...
          child: BlocBuilder<FaceDetectionCubit, FaceDetectionState>(
            ...
            builder: (context, state) {
              return Gallery<FaceDetectionCubit>(
